...
TRAINED_MODEL=${TRAINED_MODEL:-talzoomanzoo/code_memorization_seen}
DATA=${DATA:-data/code/memorization}
OUT=${OUT:-runs/Qwen2.5-3B-Instruct/code_memorization}
...
# 빠른 검증 예: LIMIT_PER_SPLIT=10 ./inference_memorization_code.sh
